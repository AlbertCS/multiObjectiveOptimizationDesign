...
class flags:
    ...
    def __init__(self, rosetta_script_xml_file, s=None, l=None, input_silent=None,
                 ...
                 score_weights=None, score_only=False, rosetta_seed=None):
        ...
        self.rosetta_seed = rosetta_seed
    ...
    def addOption(self, option, value=None):
        self.others.append((option, value))
    ...
    def write_flags(self, file_name):
        ...
        with open(file_name, 'w') as ff:
            ...
            if self.rosetta_seed:
                ff.write('-constant_seed true\n')
                ff.write(f"-jran {self.rosetta_seed}\n")
