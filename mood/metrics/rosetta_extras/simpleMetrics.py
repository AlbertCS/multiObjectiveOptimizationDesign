...
class simpleMetrics:
    ...
    class totalEnergyMetric:
        ...
        def __init__(self, name='totalEnergyMetric', label=None, reference_name=None,
                     residue_selector=None, use_native=False,
        ...
        def generateXml(self):
            ...
            if self.residue_selector != None:
                if isinstance(self.residue_selector, str):
    ...
    class RMSDMetric:
        ...
        def __init__(self, name='RMSDMetric', label=None, custom_type=None, reference_name=None,
