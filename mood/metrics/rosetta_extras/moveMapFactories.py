...
class moveMapFactory:
    ...
    def addBackboneOperation(
        self, enable=True, residue_selector=None, bb_tor_index=None
    ):

        if residue_selector == None:
            raise ValueError(
                "residue_selector = None, you must provide the name of a Residue Selector in order to add a backbone operation."
            )
    ...
    def addChiOperation(self, enable=True, residue_selector=None):
        ...
        if residue_selector == None:
            raise ValueError(
                "residue_selector = None, you must provide the name of a Residue Selector in order to add a chi operation."
            )
    ...
    def addNuOperation(self, enable=True, residue_selector=None):
        ...
        if residue_selector == None:
            raise ValueError(
                "residue_selector = None, you must provide the name of a Residue Selector in order to add a nu operation."
            )
    ...
    def addBranchesOperation(self, enable=True, residue_selector=None):
        ...
        if residue_selector == None:
            raise ValueError(
                "residue_selector = None, you must provide the name of a Residue Selector in order to add a branches operation."
            )
    ...
    def addJumpsOperation(self, enable=True, jump_selector=None):
        ...
        if jump_selector == None:
            raise ValueError(
                "jump_selector = None, you must provide the name of a Jump Selector in order to add a jumps operation."
            )
