...
def main_make_fixed_positions(
    input_path, output_path, chain_list, position_list, specify_non_fixed=False
):
        ...
        for json_str in json_list:
            ...
            for chain in all_chain_list:
                ...
                if chain not in global_designed_chain_list:
                    ...
                    idx = np.argwhere(np.array(global_designed_chain_list) == chain)[0][
                        0
                    ]
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        ...
        type=str,
        default="",
        help="List of the chains that need to be fixed",
    )
    argparser.add_argument(
        "--position_list",
        type=str,
